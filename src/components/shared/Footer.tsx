...
const Footer = () => {
    return (
        <div className="bg-[#0C0D10] border-t border-white/10 container mx-auto px-4 lg:px-10 py-8 lg:py-10 mt-12 lg:mt-16 flex flex-col lg:flex-row justify-between">
